        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <FeatureCard
              ...
              title="Análisis de PDF o imagen"
              description="Sube tu archivo y nuestra IA extraerá automáticamente."
              delay={0.1}
            />
            <FeatureCard
            ...
            <div className="bg-card rounded-3xl shadow-xl overflow-hidden border border-border relative">
              ...
              <div className="p-8 md:p-12 text-center max-w-3xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Link href="/pricing">
                    <Button size="lg" variant="outline">
                      Ver planes <ChevronRight className="ml-1 h-5 w-5" />
                    </Button>
                  </Link>
                </div>
              </div>
